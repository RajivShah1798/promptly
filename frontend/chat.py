...
def show_chat_interface():
    ...
    # Always fetch latest documents
    with st.spinner("Loading session documents..."):
    ...
    # Render chat messages + references
    ...
    if query := st.chat_input("Ask a question about your documents..."):
        ...
        with st.spinner("🔎 Generating response..."):
            try:
                ...
                # ✅ Store references with assistant message
                ...
                # Render referenced chunks immediately
                if references:
